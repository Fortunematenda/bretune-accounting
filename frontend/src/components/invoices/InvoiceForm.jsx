      ...
      <div className="lg:col-span-8 space-y-4">
        <div className="rounded-lg border border-slate-200 bg-white p-4">
          <div className="flex items-start justify-between gap-4">
            <div>
              <div className="text-sm font-medium text-slate-900">Invoice details</div>
              <div className="mt-1 text-xs text-slate-500">Invoice number is assigned when saved</div>
            </div>
            <div className="text-right">
              <div className="text-xs text-slate-500">Invoice number</div>
              <div className="text-sm font-semibold text-slate-900">{invoiceNumber || "INV-XXXX"}</div>
            </div>
          </div>
